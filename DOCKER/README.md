...
The Dockerfile for tendermint is not expected to change in the near future. The master file used for all builds can be found [here](https://raw.githubusercontent.com/cometbft/cometbft/master/DOCKER/Dockerfile).
...
To run a 4-node network, see the `Makefile` in the root of [the repo](https://github.com/cometbft/cometbft/blob/master/Makefile) and run:
...
- Tendermint's license is [Apache 2.0](https://github.com/cometbft/cometbft/blob/master/LICENSE).

## Contributing

Contributions are most welcome! See the [contributing file](https://github.com/cometbft/cometbft/blob/master/CONTRIBUTING.md) for more information.
