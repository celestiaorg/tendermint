...
JSON encoding is done using tendermint's internal json encoder. For more information on JSON encoding, please refer to [Tendermint JSON encoding](https://github.com/cometbft/cometbft/blob/ccc990498df70f5a3df06d22476c9bb83812cbe3/libs/json/doc.go)
