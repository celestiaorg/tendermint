...
type Request_GenerateFraudProof struct {
	GenerateFraudProof *RequestGenerateFraudProof `protobuf:"bytes,16,opt,name=generate_fraud_proof,json=generateFraudProof,proto3,oneof" json:"generate_fraud_proof,omitempty"`
}
type Request_VerifyFraudProof struct {
	VerifyFraudProof *RequestVerifyFraudProof `protobuf:"bytes,17,opt,name=verify_fraud_proof,json=verifyFraudProof,proto3,oneof" json:"verify_fraud_proof,omitempty"`
}
...
type RequestBeginBlock struct {
	...
	Isr                 []byte         `protobuf:"bytes,5,opt,name=isr,proto3" json:"isr,omitempty"`
}
...
func (m *RequestBeginBlock) GetIsr() []byte {
	if m != nil {
		return m.Isr
	}
	return nil
...
type RequestDeliverTx struct {
	Tx  []byte `protobuf:"bytes,1,opt,name=tx,proto3" json:"tx,omitempty"`
	Isr []byte `protobuf:"bytes,2,opt,name=isr,proto3" json:"isr,omitempty"`
}
...
func (m *RequestDeliverTx) GetIsr() []byte {
	if m != nil {
		return m.Isr
	}
	return nil
...
func (m *RequestEndBlock) GetIsr() []byte {
	if m != nil {
		return m.Isr
	}
	return nil
...
func (m *RequestGenerateFraudProof) GetTx() []byte {
	if m != nil {
		return m.Tx
	}
	return nil
...
type Response_GenerateFraudProof struct {
	GenerateFraudProof *ResponseGenerateFraudProof `protobuf:"bytes,17,opt,name=generate_fraud_proof,json=generateFraudProof,proto3,oneof" json:"generate_fraud_proof,omitempty"`
}
type Response_VerifyFraudProof struct {
	VerifyFraudProof *ResponseVerifyFraudProof `protobuf:"bytes,18,opt,name=verify_fraud_proof,json=verifyFraudProof,proto3,oneof" json:"verify_fraud_proof,omitempty"`
}
...
type ResponseVerifyFraudProof struct {
	IsFraudProofValid bool `protobuf:"varint,1,opt,name=is_fraud_proof_valid,json=isFraudProofValid,proto3" json:"is_fraud_proof_valid,omitempty"`
}
...
func (m *ResponseVerifyFraudProof) GetIsFraudProofValid() bool {
	if m != nil {
		return m.IsFraudProofValid
	}
	return false
}
...
type StateWitness struct {
	Key      []byte           `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	Value    []byte           `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
	ProofOps *crypto.ProofOps `protobuf:"bytes,3,opt,name=proof_ops,json=proofOps,proto3" json:"proof_ops,omitempty"`
}
...
func (m *StateWitness) GetProofOps() *crypto.ProofOps {
	if m != nil {
		return m.ProofOps
	}
	return nil
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
func (m *RequestBeginBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Isr) > 0 {
		i -= len(m.Isr)
		copy(dAtA[i:], m.Isr)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.Isr)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *FraudProof) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PostIsr) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.PostIsr)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.PreIsr) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.PreIsr)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *RequestBeginBlock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.Isr = append(m.Isr[:0], dAtA[iNdEx:postIndex]...)
			if m.Isr == nil {
				m.Isr = []byte{}
			}
			iNdEx = postIndex
...
func (m *ResponseVerifyFraudProof) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsFraudProofValid", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
