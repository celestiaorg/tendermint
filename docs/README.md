...
To contribute to the documentation, see [this file](https://github.com/cometbft/cometbft/blob/master/docs/DOCS_README.md) for details of the build process and considerations when making changes.
