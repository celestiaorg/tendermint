...
script](https://github.com/cometbft/cometbft/blob/master/networks/remote/integration.sh)
...
directory](https://github.com/cometbft/cometbft/tree/master/networks/remote/ansible)
...
```sh
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/cometbft/cometbft/build/tendermint -e CONFIGDIR=$GOPATH/src/github.com/cometbft/cometbft/networks/remote/ansible/mytestnet
```
