...
Golang](https://github.com/cometbft/cometbft/tree/master/abci/server). See the
...
example directory](https://github.com/cometbft/cometbft/tree/master/abci/example).
