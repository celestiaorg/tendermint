...
Refactor](https://github.com/cometbft/cometbft/blob/master/docs/architecture/adr-067-mempool-refactor.md).
...
* The [`PublicKey` type](https://github.com/cometbft/cometbft/blob/master/proto/tendermint/crypto/keys.proto#L13-L15)
...
* The `state` package now has a `Store` interface. All functions in
  [state/store.go](https://github.com/cometbft/cometbft/blob/56911ee35298191c95ef1c7d3d5ec508237aaff4/state/store.go#L42-L42)
...
```sh
go install -mod=readonly -ldflags "-X github.com/cometbft/cometbft/version.TMCoreSemVer=$(go list -m github.com/tendermint/tendermint | sed  's/ /\@/g') -s -w " -trimpath ./cmd
```
...
[here](https://github.com/cometbft/cometbft/pull/3668).
...
keys are called
[compositeKeys](https://github.com/cometbft/cometbft/blob/6d05c531f7efef6f0619155cf10ae8557dd7832f/docs/app-dev/indexing-transactions.md).
...
For further documentation on `Events`, see the [docs](https://github.com/cometbft/cometbft/blob/60827f75623b92eff132dc0eff5b49d2025c591e/docs/spec/abci/abci.md#events).
...
[work-in-progress
specification](https://github.com/cometbft/cometbft/pull/3140).
...
See [#3105](https://github.com/cometbft/cometbft/issues/3105).
Note the Unix socket has neither encryption nor authentication, but will
add a shared-secret in [#3099](https://github.com/cometbft/cometbft/issues/3099).
...
* [ADR-026](https://github.com/cometbft/cometbft/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/docs/architecture/adr-026-general-merkle-proof.md)
* [Relevant ABCI
  documentation](https://github.com/cometbft/cometbft/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/docs/spec/abci/apps.md#query-proofs)
* [Description of
  keys](https://github.com/cometbft/cometbft/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/crypto/merkle/proof_key_path.go#L14)
...
[here](https://github.com/cometbft/cometbft/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/cmd/tendermint/commands/run_node.go#L60).
